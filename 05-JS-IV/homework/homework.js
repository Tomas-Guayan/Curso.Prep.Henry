...
function tienePropiedad(objeto, propiedad) {
  ...
  // Tu código:
  if (objeto[propiedad]) {return true;} // O return objeto.hasOwnProperty(propiedad); o for (clave in objeto)if {clave===propiedad} 
